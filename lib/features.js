...
const features = {
  ...
  interactive: {
    title: 'Docker Exec Websocket Server',
    description: 'Runs another process alongside the original executed process' + 
                 'and pipes the result through websockets. Can be used for SSH-like', +
                 'access to docker containers.'
    defaults: false,
    module: require('./features/docker_exec_websocket_server')
  }
};
