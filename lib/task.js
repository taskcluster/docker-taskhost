...
/*    if(this.task.payload.features.interactive) {
      // let entrypoint = (await this.runtime.docker.getImage(config.image).inspect()).Entrypoint;
        procConfig.Entrypoint = '/.taskcluster_utils/interactive_wrapper_run.sh ' +
          this.runtime.interactive.expiration;
      debug(procConfig.Entrypoint);
    }*/
